...
class QNetwork:
    ...
    def __init__(self, input_dim=21, lr=0.00001):
        ...
        model.add(Dense(50, input_dim=input_dim, W_regularizer=l2(0.01), 
                        init='normal', activation='relu'))

        model.add(BatchNormalization())
        model.add(Dense(10,  init='normal', W_regularizer=l2(0.01), 
                        activation='relu'))
        ...
        model.add(BatchNormalization())
        model.add(Dense(2, init='normal', W_regularizer=l2(0.01),
                        activation='linear'))

        adam_opt = adam(lr=lr) #lr=0.000005
